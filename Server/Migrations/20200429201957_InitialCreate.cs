        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 9.99m, "It's cheesy and delicious. Why wouldn't you want one?", "img/pizzas/cheese.jpg", "Buffalo chicken" },
                    { 5, 11.50m, "It's like salad, but on a pizza", "img/pizzas/salad.jpg", "Veggie Delight" },
                    { 6, 11.99m, "It has mushrooms. Isn't that obvious?", "img/pizzas/mushroom.jpg", "Mushroom Lovers" },
                    { 7, 8.99m, "When in London...", "img/pizzas/brit.jpg", "The Brit" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 13, "Served on a silver platter", 2.99m },
                    { 14, "Lobster on top", 5.00m },
                    { 15, "Sturgeon caviar", 5.00m },
                    { 16, "Artichoke hearts", 4.50m },
                    { 20, "Blazing hot peppers", 1.50m },
                    { 18, "Basil", 1.00m },
                    { 19, "Steak (medium-rare)", 1.00m },
                    { 12, "Venison meatballs", 2.99m },
                    { 17, "Fresh tomatoes", 1.50m },
                    { 11, "Duck sausage", 2.50m },
                    { 7, "Bell peppers", 1.50m },
                    { 9, "Mushrooms", 1.00m },
                    { 8, "Onions", 1.00m },
                    { 21, "Buffalo chicken", 1.50m },
                    { 6, "Fresh-baked scones", 4.50m },
                    { 5, "Tea and crumpets", 5.00m },
                    { 4, "Canadian bacon", 5.00m },
                    { 3, "British bacon", 2.99m },
                    { 2, "American bacon", 2.99m },
                    { 1, "Extra cheese", 2.50m },
                    { 10, "Pepperoni", 1.50m },
                    { 22, "Blue cheese", 1.50m }
                });
